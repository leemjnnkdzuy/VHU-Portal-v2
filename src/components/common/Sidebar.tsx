...
function Sidebar({ isOpen, onClose, onLogout }: SidebarProps) {
    ...
    useEffect(() => {
        ...
        if (location.pathname.includes('/student/registration') && !location.pathname.includes('/student/registration-results')) {
    ...
    const registrationMenu: MenuGroup[] = [
        {
            ...
            items: [
                { name: 'Đăng ký học phần', path: '/student/registration', icon: PenLine },
                { name: 'Đăng ký ghi danh', path: '/student/registration/plan', icon: ClipboardList },
                { name: 'Tra cứu học phần', path: '/student/registration/search', icon: BookOpen },
                { name: 'Học phần tương đương', path: '/student/registration/equivalent', icon: Library },
                { name: 'Lịch sử đăng ký', path: '/student/registration/history', icon: ClipboardCheck },
                { name: 'Chương trình đào tạo', path: '/student/registration/program', icon: LayoutTemplate },
            ],
        },
    ];
    ...
    const mainMenu: MenuGroup[] = [
        ...
        },
        {
            ...
            items: [
                { name: 'Chương trình đào tạo', path: '/student/educational-program', icon: LayoutTemplate },
                { name: 'Thời khóa biểu', path: '/student/schedule', icon: Calendar },
                { name: 'Lịch thi', path: '/student/exam-schedule', icon: ClipboardList },
                { name: 'Quyết định sinh viên', path: '/student/decisions', icon: FileText },
                { name: 'Điểm danh', path: '/student/attendance', icon: ClipboardCheck },
                { name: 'Điểm rèn luyện', path: '/student/conduct-score', icon: BarChart3 },
                { name: 'Kết quả học tập', path: '/student/academic-results', icon: BookOpen },
                { name: 'Tài chính sinh viên', path: '/student/finance', icon: DollarSign },
                { name: 'Kết quả ĐKHP', path: '/student/registration-results', icon: PenLine },
                { name: 'HP tương đương', path: '/student/equivalent-courses', icon: Library },
            ],
        },
        {
            ...
            items: [
                ...
                { name: 'Xét tốt nghiệp', path: '/student/graduation', icon: GraduationCap },
                { name: 'Ý kiến thảo luận', path: '/student/discussion', icon: MessageSquare },
                { name: 'Đánh giá ĐRL', path: '/student/conduct-assessment', icon: BarChart3 },
                { name: 'Liên hệ - góp ý', path: '/student/contact', icon: Mail },
                { name: 'Hoạt động cộng đồng', path: '/student/community-service', icon: Heart },
                { name: 'Nộp chứng chỉ', path: '/student/certificates', icon: Library },
